...
def get_active_backend(prefer=None, require=None, verbose=0):
    ...
    if backend_and_jobs is not None:
        ...
        if verbose >= 10:
            print(
                f"Using {sharedmem_backend.__class__.__name__} as joblib.Parallel backend instead of {backend.__class__.__name__} as the latter does not provide shared memory semantics."
            )
